...
public class WebSocketFrameHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame msg) throws Exception {
        ...
        System.out.println("Web客户端(" + nameList.get(incoming.id() + "") + ")发来信息: " + msg.text());
    }
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        System.out.println("Web客户端(" + nameList.get(incoming.id() + "") + ")加入连接");
    }
    ...
    public void handlerRemoved(ChannelHandlerContext ctx) throws Exception {
        Channel incoming = ctx.channel();
        System.out.println("Web客户端(" + nameList.get(incoming.id() + "") + ")终止连接");
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        Channel incoming = ctx.channel();
        System.out.println("Web客户端(" + nameList.get(incoming.id() + "") + ")成功连接");
    }
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        Channel incoming = ctx.channel();
        System.out.println("Web客户端(" + nameList.get(incoming.id() + "") + ")断开连接");
    }
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        Channel incoming = ctx.channel();
        System.out.println("Web客户端(" + nameList.get(incoming.id() + "") + ")出现异常");
